  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws  Exception {
    http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/api/users/signup", "/api/users/idDuplicate", "/api/users/nickNameDuplicate", "/api/email/**", "/api/users/login", "/api/content/tempContent", "/imagePath/**", "/videoPath/**").permitAll() // 회원가입과 로그인은 인증 없이 접근 가능
